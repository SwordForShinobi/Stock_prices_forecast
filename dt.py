...
def run_dt():
    ...
    with col1:
        ...
        moex10 = st.number_input("MOEX10", min_value=4000, max_value=7000, value=5100)
    ...
    with col2:
        ...
        price_wti = st.number_input("Цена WTI (USD/барр)", min_value=30.0, max_value=90.0, value=65.0, step=0.1)
